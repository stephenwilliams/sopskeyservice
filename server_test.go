...
import (
	...
	"github.com/stephenwilliams/sopskeyservice/pkg/age"
	"github.com/stephenwilliams/sopskeyservice/pkg/awskms"
	"github.com/stephenwilliams/sopskeyservice/pkg/azkv"
	"github.com/stephenwilliams/sopskeyservice/pkg/gcpkms"
	"github.com/stephenwilliams/sopskeyservice/pkg/hcvault"
	"github.com/stephenwilliams/sopskeyservice/pkg/pgp"
)

func TestServer_EncryptDecrypt_PGP(t *testing.T) {
	const (
		mockPublicKey   = "pkg/pgp/testdata/public.gpg"
		mockPrivateKey  = "pkg/pgp/testdata/private.gpg"
